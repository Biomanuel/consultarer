import 'package:consultarer/dialogue/post_dialogue.dart';
...
void setupDialogUi() {
  ...
  final builders = {
    // DialogType.PhotoPreview: (context, sheetRequest, completer) => PhotoPreview(
    //       request: sheetRequest,
    //       completer: completer,
    //     ),
    // DialogType.Basic: (context, sheetRequest, completer) =>
    //     _BasicDialog(request: sheetRequest, completer: completer),
    DialogType.PostDialogue: (context, sheetRequest, completer)=>
  PostDialogue(request: sheetRequest, completer: completer),
