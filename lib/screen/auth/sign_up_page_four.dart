...
class SignUpPageFour extends ViewModelWidget<SignUpViewModel> {
  ...
  Widget build(BuildContext context, model) {
    ...
    return ListView(
      shrinkWrap: true,
      children: [
        ConsultDropDown(dropDownList: model.expertise,
            dropDownHint: model.expertise[0], groupValue: model.expertise[0]),
        Text('Rate'),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Text('Upload Profile Picture', style: textFieldLabel.copyWith(fontWeight: FontWeight.w700, color: Colors.black),),
              Padding(
                padding: const EdgeInsets.only(top: 15.0),
                child: CircleAvatar(
                  radius: 70,
                  backgroundColor: Colors.grey,child: Icon(Icons.person_rounded, color: Colors.black,size: 100,),),
              )
            ],
          ),
        )
